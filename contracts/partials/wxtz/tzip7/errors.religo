...
let errorSwapAlreadyPerformed: string = "SwapAlreadyPerformed";
let errorSwapAlreadyRefunded: string = "SwapAlreadyRefunded";
let errorHashWasNotRevealed: string = "HashWasNotRevealed";
